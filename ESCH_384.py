...
def Sparkle(eng, x, carry, number):
    ...
    for i in range(number):
        ...
        AC(eng, x6, y6, carry, c[6])
        AC(eng, x7, y7, carry, c[7])
...
(ESCH(eng, 0x201f1e1d1c1b1a191817161514131211100f0e0d0c0b0a09080706050403020100, 32))
eng.flush()
